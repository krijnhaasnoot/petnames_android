...
public final class HomeViewModel_Factory implements Factory<HomeViewModel> {
  ...
  public HomeViewModel get() {
    return newInstance(namesRepositoryProvider.get(), swipesRepositoryProvider.get(), preferencesManagerProvider.get(), analyticsManagerProvider.get());
  }
  ...
  public static HomeViewModel_Factory create(Provider<NamesRepository> namesRepositoryProvider,
      ...
      Provider<PreferencesManager> preferencesManagerProvider,
      Provider<AnalyticsManager> analyticsManagerProvider) {
    return new HomeViewModel_Factory(namesRepositoryProvider, swipesRepositoryProvider, preferencesManagerProvider, analyticsManagerProvider);
  }
  ...
  public static HomeViewModel newInstance(NamesRepository namesRepository,
    ...
    return new HomeViewModel(namesRepository, swipesRepository, preferencesManager, analyticsManager);
  }
}
